...
const EXERCISES: Record<ExerciseKey, { label: string; icon: string; camTip?: string }> = {
  free:   { label: '자유 모드', icon: '🦴' },
  squat:  { label: '스쿼트',   icon: '🏋️', camTip: '측면 촬영을 권장합니다.' },
  pushup: { label: '푸시업',   icon: '💪', camTip: '측면 촬영을 권장합니다.' },
  plank:  { label: '플랭크',   icon: '🔥', camTip: '반드시 측면에서 촬영하세요.' },
};
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 200px', gap: 14 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      ...
                      {/* 카메라 촬영 각도 안내 */}
                      {EXERCISES[motionExercise].camTip && (
                        <div style={{
                          padding: '7px 10px',
                          borderRadius: 8,
                          ...
                          <p style={{ fontSize: 10, color: '#f59e0b', lineHeight: 1.5, margin: 0 }}>
                            {EXERCISES[motionExercise].camTip}
                          </p>
                        </div>
                      )}
